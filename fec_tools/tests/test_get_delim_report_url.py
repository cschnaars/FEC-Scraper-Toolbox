...
class TestGetReportUrl(unittest.TestCase):
    ...
    """
    def test_ascii28_elec_lt_1000_filetype(self):
    ...
    def test_ascii28_elec_gt_1000_filetype(self):
        self.assertEqual('http://docquery.fec.gov/dcdev/posted/877183.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(877183, filetype='ascii28'))

    def test_ascii28_paper_lt_1000_filetype(self):
    ...
    def test_ascii28_paper_gt_1000_filetype(self):
        self.assertEqual('http://docquery.fec.gov/paper/posted/974135.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(974135, filetype='ascii28'))

    def test_csv_elec_lt_1000_filetype(self):
        """
    ...
    def test_csv_elec_gt_1000_filetype(self):
    ...
    def test_csv_paper_lt_1000_filetype(self):
    ...
    def test_csv_paper_gt_1000_filetype(self):
        self.assertEqual('http://docquery.fec.gov/paper/fecpprcsv/974135.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(974135, filetype='csv'))
    ...
    def test_ascii28_paper_gt_1000_url_patterns(self):
        self.assertEqual('http://docquery.fec.gov/paper/posted/974135.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(974135, url_patterns=[
                             'http://docquery.fec.gov/dcdev/posted/<rpt_id>.fec',
                             'http://docquery.fec.gov/paper/posted/<rpt_id>.fec']))
    ...
    def test_ascii28_elec_lt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/dcdev/posted/1008299.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(1008299, a_id='asciifile'))

    def test_ascii28_elec_gt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/dcdev/posted/877183.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(877183, a_id='asciifile'))

    def test_ascii28_paper_lt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/paper/posted/1006117.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(1006117, a_id='asciifile'))

    def test_ascii28_paper_gt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/paper/posted/974135.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(974135, a_id='asciifile'))

    def test_csv_elec_lt_1000_a_id(self):
        """
        The xxx in the expected URL is a randomly generated folder in the actual URL.
        """
        url = fec_tools.lib.get_delim_report_url.get_delim_report_url(1008299, a_id='csvfile')
        # Replace random folder name with xxx
        url_mod = url[:url.find('/showcsv/') + 9] + 'xxx' + url[len(url) - url[::-1].find('/') - 1:]
        self.assertEqual('http://docquery.fec.gov/showcsv/xxx/1008299.fec', url_mod)
    ...
    def test_csv_elec_gt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/comma/877183.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(877183, a_id='csvfile'))

    def test_csv_paper_lt_1000_a_id(self):
        self.assertEqual('http://docquery.fec.gov/paper/fecpprcsv/1006117.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(1006117, a_id='csvfile'))

    def test_csv_paper_gt_1000_a_id(self):
        # Failed
        self.assertEqual('http://docquery.fec.gov/paper/fecpprcsv/974135.fec',
                         fec_tools.lib.get_delim_report_url.get_delim_report_url(974135, a_id='csvfile'))
