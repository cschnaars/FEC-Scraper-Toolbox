 ...
 * Header: all versions through 8.0 (v1 and v2 hardcoded)
 * F1: all versions through 8.0
 * F1S: all versions through 8.0 (first used in v3)
 * F3: all versions through 8.0
 * F3L: all versions through 8.0 (first used in v6.4)
 * F3P: all versions through 8.0
 * F3X: all versions through 8.0
 * SA: all versions through 8.0
 * SB: all versions through 8.0
 * SC: all versions through 8.0
 * SC1: all versions through 8.0
 * SC2: all versions through 8.0 (does not exist in v1)
 * SD: all versions through 8.0
 * SE: all versions through 8.0
 * SF: all versions through 8.0
 * H1: all versions through 8.0
 * H2: all versions through 8.0
 * H3: all versions through 8.0 (temporarily removed v1 and v2)
 * H4: all versions through 8.0
 * H5: all versions through 8.0 (first used in 5.0)
 * H6: all versions through 8.0 (first used in 5.0)
 * SI: all versions through 7.0 (FEC discontinued as of 8.0)
 * SL: all versions through 8.0 (first used in 5.0)
 * TEXT: all versions through 8.0 (does not exist in v1 or v2)
"""
...
filehdrs = [['F1', [[['1', '2'], ['FormTp', 'CommID', 'CommNm', 'Addr1', 'Addr2', 'City', 'StAbbr', 'Zip', 'SubmDt', 'flgChgCommNm', 'flgAddrChg', 'CommTp', 'CandID', 'CandFullName', 'CandOff', 'CandStAbbr', 'CandDist', 'PtyCd', 'PtyTp', 'AffCommID', 'AffCommNm', 'AffAddr1', 'AffAddr2', 'AffCity', 'AffStAbbr', 'AffZip', 'AffRelCd', 'AffOrgTp', 'CustFullName', 'CustAddr1', 'CustAddr2', 'CustCity', 'CustStAbbr', 'CustZip', 'CustTitle', 'CustPhone', 'TrsFullName', 'TrsAddr1', 'TrsAddr2', 'TrsCity', 'TrsStAbbr', 'TrsZip', 'TrsTitle', 'TrsPhone', 'AgtFullName', 'AgtAddr1', 'AgtAddr2', 'AgtCity', 'AgtStAbbr', 'AgtZip', 'AgtTitle', 'AgtPhone', 'Bank1Nm', 'Bank1Addr1', 'Bank1Addr2', 'Bank1City', 'Bank1StAbbr', 'Bank1Zip', 'SignFullName', 'SignDt']],
    ...
    [['6.3', '6.4', '7.0', '8.0'], ['FormTp', 'CommID', 'JtFndCommNm', 'JtFundCommID', 'AffCommID', 'AffCommNm', 'AffCandID', 'AffLName', 'AffFName', 'AffMName', 'AffPfx', 'AffSfx', 'AffAddr1', 'AffAddr2', 'AffCity', 'AffStAbbr', 'AffZip', 'AffRelCd', 'AgtLName', 'AgtFName', 'AgtMName', 'AgtPfx', 'AgtSfx', 'AgtAddr1', 'AgtAddr2', 'AgtCity', 'AgtStAbbr', 'AgtZip', 'AgtTitle', 'AgtPhone', 'BankNm', 'BankAddr1', 'BankAddr2', 'BankCity', 'BankStAbbr', 'BankZip']]]],
    ...
    [['6.4', '7.0', '8.0'], ['FormTp', 'CommID', 'CommNm', 'AddrChg', 'Addr1', 'Addr2', 'City', 'StAbbr', 'Zip', 'ElecSt', 'ElecDist', 'RptCd', 'ElecCd', 'ElecDt', 'StateOfElec', 'CovgFmDt', 'CovgToDt', 'TrsLName', 'TrsFName', 'TrsMName', 'TrsPfx', 'TrsSfx', 'SignDt', 'TotConts_P_6a', 'TotContRfds_P_6b', 'NetConts_P_6c', 'TotOpExps_P_7a', 'TotOffsetOpExps_P_7b', 'NetOpExps_P_7c', 'CashClose_P_8', 'DebtsTo_P_9', 'DebtsBy_P_10', 'IndContsItem_P_11a1', 'IndContsUnitem_P_11a2', 'IndContsTot_P_11a3', 'PolPtyCommConts_P_11b', 'OthPolCommConts_P_11c', 'CandConts_P_11d', 'TotConts_P_11e', 'TranFmOthAuthComms_P_12', 'CandLoans_P_13a', 'OthLoans_P_13b', 'TotLoans_P_13c', 'OffsetOpExps_P_14', 'OthRcpts_P_15', 'TotRcpts_P_16', 'OpExps_P_17', 'TranToOthAuthComms_P_18', 'CandLoansRepaid_P_19a', 'OthLoansRepaid_P_19b', 'TotLoansRepaid_P_19c', 'RefundsInd_P_20a', 'RefundsPolPtyComms_P_20b', 'RefundsOthPolComms_P_20c', 'TotRefunds_P_20d', 'OthDisb_P_21', 'TotDisb_P_22', 'CashBegin_P_23', 'TotRcpts_P_24', 'Subtotal_P_25', 'TotDisb_P_26', 'CashClose_P_27', 'TotConts_T_6a', 'TotContRfds_T_6b', 'NetConts_T_6c', 'TotOpExps_T_7a', 'TotOffsetOpExps_T_7b', 'NetOpExps_T_7c', 'IndContsItem_T_11a1', 'IndContsUnitem_T_11a2', 'IndContsTot_T_11a3', 'PolPtyCommConts_T_11b', 'OthPolCommConts_T_11c', 'CandConts_T_11d', 'TotConts_T_11e', 'TranFmOthAuthComms_T_12', 'CandLoans_T_13a', 'OthLoans_T_13b', 'TotLoans_T_13c', 'OffsetOpExps_T_14', 'OthRcpts_T_15', 'TotRcpts_T_16', 'OpExps_T_17', 'TranToOthAuthComms_T_18', 'CandLoansRepaid_T_19a', 'OthLoansRepaid_T_19b', 'TotLoansRepaid_T_19c', 'RefundsInd_T_20a', 'RefundsPolPtyComms_T_20b', 'RefundsOthPolComms_T_20c', 'TotRefunds_T_20d', 'OthDisb_T_21', 'TotDisb_T_22']]]],
    ['F3L', [[['6.4', '7.0', '8.0'], ['FormTp', 'CommID', 'CommNm', 'AddrChg', 'Addr1', 'Addr2', 'City', 'StAbbr', 'Zip', 'ElecSt', 'ElecDist', 'RptCd', 'ElecDt', 'StateOfElec', 'flgInclSemiAnnPrd', 'CovgFmDt', 'CovgToDt', 'flgInclSemiAnnJanJun', 'flgInclSemiAnnJulDec', 'TotRptBundContribs', 'SemiAnnBundContribs', 'TrsLName', 'TrsFName', 'TrsMName', 'TrsPfx', 'TrsSfx', 'SignDt']]]],
    ...
    ['SC1', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'BkRefTransID', 'Lender', 'LenderAddr1', 'LenderAddr2', 'LenderCity', 'LenderState', 'LenderZip', 'LoanAmt', 'IntRt', 'IncurredDt', 'DueDt', 'flgLoanRestructured', 'OrigLoanDt', 'CrdtAmtThisDraw', 'TotBlnc', 'flgOthersLiable', 'flgCollateral', 'CollateralDesc', 'CollateralVal', 'flgPerfectedInt', 'flgFutIncPledged', 'FutIncDesc', 'FutIncEstVal', 'DepAcctEstDt', 'AcctLocName', 'AcctLocAddr1', 'AcctLocAddr2', 'AcctLocCity', 'AcctLocState', 'AcctLocZip', 'DepAcctAuthDt', 'LoanBasisDesc', 'TrsLName', 'TrsFName', 'TrsMName', 'TrsPfx', 'TrsSfx', 'TrsSignDt', 'LendRepLName', 'LendRepFName', 'LendRepMName', 'LendRepPfx', 'LendRepSfx', 'LendRepTitle', 'LendRepSignDt']],
    ...
    ['SC2', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'BkRefTransID', 'GuarLName', 'GuarFName', 'GuarMName', 'GuarPfx', 'GuarSfx', 'GuarAddr1', 'GuarAddr2', 'GuarCity', 'GuarState', 'GuarZip', 'GuarEmp', 'GuarOcc', 'GuarAmt']],
    ...
    ['SD', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'EntTp', 'CreditorOrgName', 'CreditorLName', 'CreditorFName', 'CreditorMName', 'CreditorPfx', 'CreditorSfx', 'CreditorAddr1', 'CreditorAddr2', 'CreditorCity', 'CreditorState', 'CreditorZip', 'DebtPurp', 'BegBlnc_P', 'IncurAmt_P', 'PymtAmt_P', 'BalClose_P']],
    ...
    ['H1', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'flgStLocFxPctPresOnly', 'flgStLocFxPctPresAndSen', 'flgStLocFxPctSenOnly', 'flgStLocFxPctNonPresNonSen', 'flgFlatMin50PctFed', 'FedPct', 'NonFedPct', 'flgAdmRatio', 'flgGenericVoterDrvRatio', 'flgPubCommunRefPrtyRatio']],
    ...
    ['H2', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'EventNm', 'flgDirFndrsg', 'flgDirCandSup', 'RatioCd', 'FedPct', 'NonFedPct']],
    ...
    ['H3', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'BkRefTransID', 'AcctNm', 'EventTp', 'EventNm', 'RcptDt', 'TotAmtTrans', 'TransAmt']],
...
#    [['1'], ['LineNbr', 'CommID', 'AcctNm', 'RcptDt', 'TotAmtTrans', 'AdmVtrDrv', 'EventNm', 'EventNbr', 'TransAmt', 'EventNm2', 'EventNbr2', 'TransAmt2', 'EventNm3', 'EventNbr3', 'TransAmt3', 'EventNm4', 'EventNbr4', 'TransAmt4', 'TotDirFndrsgAmt', 'EventNm5', 'EventNbr5', 'TransAmt5', 'EventNm6', 'EventNbr6', 'TransAmt6', 'EventNm7', 'EventNbr7', 'TransAmt7', 'EventNm8', 'EventNbr8', 'TransAmt8', 'TotExemptActDirCandSup', 'AmendCd']]
    ...
    ['TEXT', [[['6.1', '6.2', '6.3', '6.4', '7.0', '8.0'], ['LineNbr', 'CommID', 'TransID', 'BkRefTransID', 'BkRefSchdNm', 'FullText']],
